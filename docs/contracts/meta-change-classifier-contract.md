...
| `docs/contracts/authority-custody-defaults.md` | `authority_change` | Defines local write authority, credential/content custody, consent, team confinement, proposal-branch/CI authority, bounded Git/process behavior, and external-contract verification. |
