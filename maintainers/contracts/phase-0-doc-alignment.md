...
This inventory aligns supporting docs with the owner-sovereign Agentic Factory
...
- Agentic Factory is the adopter-facing product name; The predecessor codename remains private.
...
- The behavior repo is the Agentic Factory behavior repo. Product repos are not
...
- Any product-repo connection or broader workspace/domain expansion beyond the
  owner-deliberate Agentic Factory behavior repo and initial Linear team.
