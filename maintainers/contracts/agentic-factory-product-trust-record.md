# Agentic Factory Product Trust Record
...
Agentic Factory helps a product-savvy, technical-adjacent founder, product
...
2. Approve or decline Agentic Factory behavior-change PRs in GitHub.
...
or work item to `Planned` in an Agentic Factory Linear team.
...
When a bounded agent task runs, Agentic Factory reports what passed
...
team that will use Agentic Factory. Init creates or configures that team,
creates a private Agentic Factory behavior repo, starts Phoenix, and wires the
...
First-run copy must say that Agentic Factory does not touch product code unless
...
action. Attached Linear teams share the same Agentic Factory behavior repo and
...
When Agentic Factory cannot continue safely, the terminal concierge says what
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| GitHub App installation for behavior repo | TBD by authority/custody contract | Create and verify the private behavior repo | System-created Agentic Factory behavior repo by repo id | Behavior repo access and verification | No in normal v1 setup | TBD by authority/custody contract | Fixed-scope v1 setup |
...
| Linear OAuth authorization | Linear access through Agentic Factory OAuth and GraphQL | Read product intent and write validated Linear artifacts | Chosen Linear workspace/team | Reads, project updates, issues, issue relations, status changes as validated | No | Revoke Linear app authorization | Fixed-scope v1 setup |
| Linear workspace and initial team | Workspace choice and team name | Create/configure the product work container | Chosen Linear workspace and named team | Agentic Factory team/status/labels/template as needed | No | Remove/disconnect team through setup repair path | Fixed-scope v1 setup |
...
product-language receipt at the point Agentic Factory can honestly observe with
