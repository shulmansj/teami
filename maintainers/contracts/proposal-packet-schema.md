...
This contract defines the product-readable proposal packet for Agentic Factory
...
```text
agentic-factory-proposal-packet/v1
```
...
| --- | --- | --- |
| `schema_version` | Packet object schema version. | Constant, currently `agentic-factory-proposal-packet/v1`. |
...
`agentic_factory_promotion` marker:
