...
export const PROTECTED_SLOTS = Object.freeze({
  ...
  exact_paths: Object.freeze([
    ...
    { path: "execution/integrations/linear/src/github-secret-hygiene.mjs", class: "authority_change", surface: "github_secret_hygiene" },
    ...
    { path: "execution/integrations/linear/src/local-trigger-store.mjs", class: "authority_change", surface: "local_trigger_store_authority" },
    { path: "execution/integrations/linear/src/trigger-idempotency.mjs", class: "authority_change", surface: "trigger_idempotency_authority" },
    { path: "execution/integrations/linear/src/team-resolver.mjs", class: "authority_change", surface: "team_credential_routing" },
    { path: "execution/integrations/linear/src/team-command-context.mjs", class: "authority_change", surface: "team_credential_routing" },
...
const AUTHORITY_HUNK_PATTERNS = Object.freeze([
  ...
  {
    id: "authority_credential_or_token",
    surface: "credential_or_token_authority",
    pattern: /\b(token|credential|oauth|secret|private key|installation token|bearer)\b/i,
  },
  {
  ...
  },
  {
    ...
    pattern: /\b(mutate linear|linear mutation|linear graphql mutation|linear_write|project_mutation|issue_mutation|tool_policy|repository permission|selected[-_ ]?repo|endpoint allowlist|tool\/write authority|write access)\b/i,
  },
  {
