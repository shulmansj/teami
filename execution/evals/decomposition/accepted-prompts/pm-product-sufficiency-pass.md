...
Assess the Problem Or Opportunity, Desired Outcome, Acceptance Evidence, Scope Boundaries, Constraints And Decisions, and Open Questions. Preserve the human's intent; do not silently resolve product, taste, trust, launch, or business tradeoffs.
...
On needs_product_input, author the human-facing product questions that block decomposition. Each question should explain what is unknown, why it blocks the work, and what would change depending on the answer. Include an update for the orchestrator that names the need and the next human action.
